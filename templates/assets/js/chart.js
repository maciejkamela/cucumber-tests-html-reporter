...
app.chart = (function() {
  ...
  return {
    ...
    init: function() {
      ...
      canvas.onmousemove = function(e) {
        ...
        if (hex.toLowerCase() === data.colors.cs[0].toLowerCase()) {
          chartCtx.fillText(passed, a, b + 20);
          chartCtx.font = '18pt Roboto';
          ...
          chartCtx.fillText(failed, a, b + 20);
          chartCtx.font = '18pt Roboto';
    ...
    displayDefaultStatistics: function(canvas, passedAmount, failedAmount) {
      canvas.font = '40pt Roboto';
      canvas.textAlign = 'center';
      if (passedAmount >= failedAmount) {
        canvas.fillStyle = '#1dcb34';
        canvas.fillText(passedAmount, 250, 200);
        canvas.font = '18pt Roboto';
        canvas.fillText("Scenarios", 250, 240);
        canvas.fillText("passed", 250, 270);
      } else {
        canvas.fillStyle = '#ed1c24';
        canvas.fillText(failedAmount, 250, 240);
        canvas.font = '18pt Roboto';
        canvas.fillText("Scenarios", 250, 280);
        canvas.fillText("failed", 250, 320);
      }
    },
